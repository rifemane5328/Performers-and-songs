...
app.include_router(performers_router, tags=['performers, performer, performer_by_id'])
app.include_router(albums_router, tags=['albums, album, album_by_id'])
app.include_router(songs_router, tags=['songs, song, song_by_id'])
